    ...
    def execute(self):
        ...
        try:
            ...
            if not self.action.ldap_dn_template:
                return {
                    'success': False,
                    'message': 'LDAP DN template not configured'
                }
    ...
    def _update_ldap(self, dn, attributes):
        ...
        try:
            ...
            if not all([server_uri, bind_dn, bind_password]):
                return {
                    'success': False,
                    'message': 'LDAP configuration incomplete'
                }
            ...
            return {
                'success': False,
                'message': 'python-ldap library not installed'
            }
        except Exception as e:
            return {
                'success': False,
                'message': f'LDAP update failed: {str(e)}'
            }
